...
namespace ProcessingApp.Migrations
{
    ...
    [Migration("20191209025759_seedOwnerAndProperty")]
    partial class seedOwnerAndProperty
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProcessingApp.Models.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("ProcessingApp.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ProcessingApp.Models.OwnerModel", b =>
                {
                    ...
                    b.HasData(
                        new { OwnerId = 3, OwnerName = "LLC Test" },
                        new { OwnerId = 4, OwnerName = "Barsukov&Co" }
                    );
                });

            modelBuilder.Entity("ProcessingApp.Models.PropertyModel", b =>
                {
                    b.Property<int>("PropertyId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("PropertyCreateViewModel");

                    b.HasData(
                        new { PropertyId = 12, City = "Seed", ImageUrl = "", PropertyAdress = "SeedDrive", PropertyName = "SeededHome", PropertyPrice = 95.5 }
                    );
                });

            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("ProcessingApp.Models.ApplicationRole")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ProcessingApp.Models.ApplicationUser")
                        .WithMany()
